...
\begin{solution}
No, the VM does not need to modify the %cr3 register on every context switch because it uses EPT which provides each VM it's own memory and it's own %cr3 register.
\end{solution}
